...
file_env 'RESTORE_TARGET_POSTGRES_USER'
if [ -z "${RESTORE_TARGET_POSTGRES_USER}" ]; then
  RESTORE_TARGET_POSTGRES_USER=docker
fi
...
file_env 'RESTORE_TARGET_POSTGRES_PASS'
if [ -z "${RESTORE_TARGET_POSTGRES_PASS}" ]; then
  RESTORE_TARGET_POSTGRES_PASS=docker
fi
...
file_env 'RESTORE_TARGET_POSTGRES_HOST'
if [ -z "${RESTORE_TARGET_POSTGRES_HOST}" ]; then
  RESTORE_TARGET_POSTGRES_HOST=localhost
fi
...
file_env 'RESTORE_TARGET_POSTGRES_PORT' 
if [ -z "${RESTORE_TARGET_POSTGRES_PORT}" ]; then
  RESTORE_TARGET_POSTGRES_PORT=5432
fi
...
RESTORE_PG_CONN_PARAMETERS="-h ${RESTORE_TARGET_POSTGRES_HOST} -p ${RESTORE_TARGET_POSTGRES_PORT} -U ${RESTORE_TARGET_POSTGRES_USER}"
...
export RESTORE_TARGET_POSTGRES_USER=\"${RESTORE_TARGET_POSTGRES_USER}\"
export POSTGRES_PASS=\"$POSTGRES_PASS\"
export RESTORE_TARGET_POSTGRES_PASS=\"${RESTORE_TARGET_POSTGRES_PASS}\"
export POSTGRES_PORT="${POSTGRES_PORT}"
export RESTORE_TARGET_POSTGRES_PORT="${RESTORE_TARGET_POSTGRES_PORT}"
export POSTGRES_HOST=\"${POSTGRES_HOST}\"
export RESTORE_TARGET_POSTGRES_HOST=\"${RESTORE_TARGET_POSTGRES_HOST}\"
...
export RESTORE_PG_CONN_PARAMETERS=\"${RESTORE_PG_CONN_PARAMETERS}\"
